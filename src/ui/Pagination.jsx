...
function Pagination({ count }) {
  ...
  return (
    <StyledPagination>
      <P>
        Showing <span>{(currentPage - 1) * PAGE_SIZE + 1}</span> to <span>{currentPage === countPage ? count : currentPage * PAGE_SIZE}</span>
      ...
      <Buttons>
        ...
        <PaginationButton onClick={handleNext} disabled={currentPage === countPage}>
          <span>Next</span>
          <HiChevronRight />
        </PaginationButton>
      </Buttons>
